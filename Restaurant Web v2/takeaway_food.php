...
<div class="modal fade" id="abc11" tabindex="-1" aria-labelledby="abc11" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">Smirnoff adalah minuman anti anak kecil
...
echo '  
<div class="modal fade" id="abc12" tabindex="-1" aria-labelledby="abc12" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="abc12">Iceland Vodka</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
