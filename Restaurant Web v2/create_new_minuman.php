<?php
	...
	$count = mysqli_query($resto, "SELECT *FROM menu_minuman");
	$counter =0;
	...
	echo "<input type = 'submit' value = 'Submit Makanan' name = 'submit_minuman' id ='submitan'> ";
	
	echo "</form></div>";

?>
<?php
	if (isset($_POST['submit_minuman'])){
		$get_no = $_POST['no'];
		$get_nama = $_POST['nama'];
		$get_harga = $_POST['harga'];
		$get_link = $_POST['link'];

		mysqli_query($resto, "INSERT INTO menu_minuman VALUES ('$get_no', '$get_nama', $get_harga, '$get_link')");
	}
?>